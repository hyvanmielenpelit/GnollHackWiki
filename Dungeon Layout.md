...
| **[[/Dungeon/Wizard's Tower]]** | 10–13 | A three-level tower holding the [[/Monsters/Wizard of Yendor]] and the [[/Artifacts/Book of the Dead]]. It can be entered only through a magic portal in one of the [[/Dungeon/Fake Wizard's Towers]]. |
