...
The modern version of GnollHack has two modes for permadeath:

### Modern Mode — Classic Mode Disabled

In the modern mode, you respawn at a certain altar upon death.

### Classic Mode

If the classic mode is enabled, death will be permanent, and once dead, you will need to start the game again.
...
You can control the number of available commands through the **Simple Command Layout** option in the settings. If you disable it, you will get more commands than in the simple mode.
...
* If you find a [[/Items/scroll of identify]], you can read it to identify one or more items. Even a cursed scroll will do.
* Shopkeepers will identify items for a fee.
* Oracle will identify items for a fee.
* You can use a [[/Items/wand of identify]] to identify several items.
* Experienced players identify items in a shop based on their price.
* You can apply _an uncursed or blessed [[/Items/touchstone]]_ (one of the gray stones) on a gem to identify it.
...
You can fire missiles in GnollHack to 8 basic directions. You need to wield a launcher to fire appropriate missiles. For example, you need a bow to fire arrows, a crossbow to fire bolts, and a sling to fire sling stones. Fired missiles have a range that is based on the launcher. You can check this range by examining the launcher. One square is 5'&times;5'.

* If your ranged weapon is not readied, click Swap (keyboard shortcut: 'x') to change weapon sets and then to Wield your ranged weapon (keyboard shortcut: 'w').
* It is usually best to keep your melee weapon in one set and your ranged weapon in the second set and change between them by using Swap. This will not cost you a turn.
* Use the Quiver command (keyboard shortcut: 'Q') to put your arrows or bolts into a quiver.
* Use Fire (keyboard shortcut: 'f') to fire a missile from your quiver.
...
You can throw items in GnollHack to 8 basic directions. The throwing distance of an item is listed with its examine information. One square is 5'&times;5'.

* Use the Throw command (keyboard shortcut: 't') to throw a throwing weapon in your inventory.
...
* You can use the Polearm command to hit with it two squares away. Alternatively, you can apply the polearm (keyboard shortcut: 'a').
* This is a safe way to kill some monsters that have dangerous melee attacks, such as sea creatures.

### Two-weapon fighting

You can start striking with both your right and left hand by 2-Weaponing (keyboard shortcut: 'Ctrl-x'). A yellow '2Weap'-sign will appear on your status row to indicate that your in the two weapon fighting mode. To stop two weapon fighting, click 2-Weapon (keyboard shortcut: 'Ctrl-X') again. In two weapon fighting, you can hit with the weapons in your both hands (and even a shield if it is in your left hand), but you receive a significant penalty to hit and damage in doing so, unless you are particularly proficient in the two weapon fighting skill.
...
Most corpses become rotten very fast, which means that you should eat them immediately after you have killed the monsters. If you eat a rotten or tainted corpse, you will become deathly sick and die within a few turns. If this happens, you can Pray to your god (keyboard shortcut: Alt-p) to heal you.
...
* Do not eat leprechauns or other teleporting monsters. It will give you _teleportitis_. Nymphs are an exception to this in GnollHack.
...
Spells in GnollHack work differently than in NetHack. Most spells require a material component to prepare. You must first Mix the spells using (keyboard shortcut: 'X'), which gives you a number of castings for that spell. Then, you can Cast the spells in a normal way by using (keyboard shortcut: 'Z').
...
* Remember that wearing heavy armor will make spell casting more difficult. You can check armor's spell casting penalty in its Examine information.
...
Magic school skills give you +100% bonus per skill level to cast appropriate spells and also reduce their mana cost a bit.

When you can spend skill slots:

- A green skill icon will appear by the character in the modern UI.
- In the legacy UI, a green "Skill" text will appear in the status bar.

## Praying

You can Pray (keyboard shortcut: 'Alt-p') in GnollHack. If you pray in an emergency situation and your god is pleased with you, you will be saved from the situation. You should remember to do so, whenever you have lycanthropy, petrification, low hit points, you are deathly sick, and so on.
...
If an altar is of the same alignment as you, you can additionally use the altar to Sacrifice monsters to your god (keyboard shortcuts: 'Alt-o' — Offer). If the sacrifice is of adequately high level and is not rotten, it can have a number of beneficial effects:

* It can increase your luck
* You can be gifted an artifact weapon by your god

Sacrificing is the best way to get artifacts in the early game. Also, having a [[/Items/wand of create monster]] is greatly useful, when you want to create monsters to sacrifice for your god.
...
If you drop _uncursed [[potions of water|/Items/potion of water]]_ upon an altar of your alignment and pray, they will be converted to _holy water_. You can _dip items_ (keyboard shortcut: 'Alt-d') into holy water to make uncursed items blessed and to remove the curse of cursed items.
