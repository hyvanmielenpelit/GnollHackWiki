> 👉 **This page details the exact odds of successfully wishing for enchanted items in GnollHack, explaining why wishing for a +5 weapon usually results in a +0 item.**

When you wish for an enchanted item (like a weapon or armor) with a specific enchantment level, such as a "+3 long sword", the game performs a safety check. If you ask for an enchantment that is deemed too high by the game's internal random rolls, your wish "evaporates," and you are given a +0 item instead.

This mechanic prevents players from easily acquiring maximally enchanted gear without engaging with the game's enchantment systems (like reading scrolls of enchant weapon).

## The Double-Roll Mechanic

When a wish is made, the game rolls two independent random enchantment values based on the type of item you requested. For your wish to succeed and grant the requested enchantment, the amount you asked for must be less than or equal to **at least one** of these two random rolls. 
...
### Single-Handed Weapons & Elven Armor
This includes typical weapons like the Long Sword, and Elven items like the Elven Cloak. These have a hard cap of +4.
...
This includes large weapons like the Two-Handed Sword or Halberd. These can technically generate up to +7, making a +4 or +5 wish possible, though exceptionally rare.
...
### Magical Rings
Magical rings do not use the heavily skewed generation formula. Instead, they roll uniformly between 1 and 5 (a flat 20% chance for each number). As a result, it is much safer to wish for a highly enchanted ring than it is to wish for highly enchanted armor or weapons.
