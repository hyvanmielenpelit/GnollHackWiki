...
- **Wikilinks**: Use Gollum-style links. Wikilinks IN markdown files in subdirectories need to start with a slash (/) (e.g., `[[/Path/to/Page]]`). Wikilinks IN markdown files IN the root directory must NOT start with a slash (/) (e.g., `[[Page Name]]`). It doesn't matter what page the wikilinks refer to. Do NOT include `.md`.
