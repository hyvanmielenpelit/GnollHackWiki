...
- **Respect for Your Time:** The pacing and quality of life are vastly improved. The leveling curve is faster, and the dungeons are shorter. Notably, Gehennom has **no mazes** except on special levels! Tedious mechanics, such as constant stealing from shops, have been replaced with a stronger economy and more action-oriented gameplay. Hit points and mana also regenerate much faster.
