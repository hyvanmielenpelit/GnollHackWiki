...
- GnollHack has a modern graphical user interface on Android, iOS, macOS, and Windows.
- GnollHack has real 2D animations. NetHack has no animations.
- GnollHack has sound effects, music, and voiceovers. NetHack has no sounds.
...
* GnollHack has difficulty levels and game modes appropriate for beginning players.
