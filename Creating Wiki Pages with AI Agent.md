...
> ℹ️ **Note:** You may need a paid **Google One AI subscription** to use recommended AI agents. You can subscribe via the [Google One AI plan subscription page](https://one.google.com/about/google-ai-plans/). The recommended AI agent for most tasks is *Gemini 3.5 Flash (Medium)*, which may require the **$100 Google AI Ultra** plan due to *high token usage*. If you have only the **Google AI Pro** plan, the recommended agent is *Gemini 3.1 Pro (High)* (because it consumes fewer tokens), except for seldomly using *Gemini 3.5 Flash (Medium)* for hard tasks.
