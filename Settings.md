...
| **Graphics Style** | Tiles / ASCII | Tiles | Shows the game in 2D tile graphics or in ASCII text. |
| **Map FPS** | 20 to 144 | 60 | Determines the max refresh rate of the game. This can be used to save battery or to make the game smoother. |
| **Screen Resolution** | Multiple resolutions | Native | Determines the rendering resolution of the game map. |
...
| **Cursor Style** | Green Block / Blinking Underline | Green Block | *(ASCII graphics only)* Determines the way how the player character is identified in the game. |
...
| **Tournament Mode** | On / Off | Off | Toggles several other settings to values required by tournaments like [[Junethack]]. Also forces on [[Classic Mode]]. More info about [[tournament mode]]. |
...
| Setting Name | Options / Values | Default | Description |
|---|---|---|---|
| **Menu Fade Effects** | On / Off | On | Determines whether the texts in the menu and text pages fade in and out when opening and closing the page. |
...
| **Worn Shows Equipment** | On / Off | Off | Determines whether the worn item menu shows an equipment screen with all body slots or just a list of currently worn items. |
...
| Setting Name | Options / Values | Default | Description |
|---|---|---|---|
| **Simple Command Layout** | On / Off | On | **Off:** Shows two rows of commands in the bottom of the screen, and extra commands in more commands.<br>**On:** Shows one row of commands and only the most important extra commands in more commands. |
...
| **Show Score** | On / Off | Off | Displays the game score on the status bar. |
| **Show XP** | On / Off | Off | Displays experience points on the status bar. |
...
| **Grid Opacity** | 5% to 100% | 100% | Adjusts the opacity of the grid lines if they are shown. |
...
| **Pet Rows** | 1 to 4 | 2 | Determines how many rows of pet icons are allowed in the top of the screen. |
...
| **Right Mouse Button** | Action | None | Configures a specific action or command for a right mouse click. |
| **Middle Mouse Button** | Action | None | Configures a specific action or command for a middle mouse click. |
| **Quick Engrave Text** | Text String | None | Text that is engraved automatically when using the quick engrave command. |
| **Quick Engrave Style** | Engrave Method | Write in Dust | Specifies the method to use for quick engraving (e.g., finger, wand). |
