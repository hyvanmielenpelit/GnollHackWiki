...
Characters in GnollHack have a nutrition level that dictates their current hunger state. Maintaining a well-fed status is crucial, as hunger states directly impact attributes, speed, and overall survival.
...
| **[[/Items/Cloudberry]]** | 15 | Restores lost attributes | Works like a potion of restore ability. |
...
| **Intelligence** | [[/Monsters/Tentacled one]], [[/Monsters/Elder tentacled one]], all [[/Monsters/Lichen]] (Lichen, White, Black) | **25%** (Tentacled)<br>**1% – 30%** (Lichens) | Lichen difficulty determines the chance (Lichen: 1%, Black Lichen: 7%). |
...
| **Charisma** | All [[/Monsters/Nymphs]] and [[/Monsters/Harpy]] | **25%** (Nymphs)<br>**25%** (Harpy) | Nymphs include Wood, Water, and Mountain nymphs. |
| **All Attributes** | [[/Monsters/Titan]] | **20%** | Titanium size conveys Strength, Constitution, Intelligence, Wisdom, and Charisma. |
