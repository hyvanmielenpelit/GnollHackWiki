...
> 👉 **GnollHack is an ambitious open-source project that bridges the gap between decades-old legacy C code and modern cross-platform development paradigms, serving as a rare and powerful showcase of [.NET MAUI](https://learn.microsoft.com/en-us/dotnet/maui/)'s capabilities in game development.**
...
- **.NET MAUI as a Game Engine:** While [.NET MAUI](https://learn.microsoft.com/en-us/dotnet/maui/) is traditionally seen as a framework for business apps, GnollHack pushes it to the edge. We utilize .NET MAUI to drive a complex, highly-interactive 2D game, proving its viability for high-performance, non-standard UI requirements.
...
GnollHack is one of the very few games developed with **[.NET MAUI](https://learn.microsoft.com/en-us/dotnet/maui/)**, which is primarily a cross-platform app creation framework. GnollHack extends the boundaries of .NET MAUI by implementing a fully fledged 2D game. .NET MAUI allows GnollHack to run on Android, iOS, Windows, and macOS.
